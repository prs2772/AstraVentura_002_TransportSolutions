...
public class MongoVehicleRepository : IVehicleRepository
{
    ...
    {
        var connectionString = configuration.GetConnectionString("AutoFleetMongoConnection");
        var databaseName = configuration.GetConnectionString("ConnectionStrings:AutoFleetMongoDbName") ?? "AutoFleetMongoDbName";
